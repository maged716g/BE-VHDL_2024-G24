...
module SOPC_verin_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> Gestion_verin_0_avalon_slave_0_agent:cp_channel
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> sysid_qsys_1_control_slave_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sysid_qsys_1_control_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // sysid_qsys_1_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sysid_qsys_1_control_slave_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> sysid_qsys_1_control_slave_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> sysid_qsys_1_control_slave_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_1_s1_agent:cp_data
	...
	wire         sysid_qsys_1_control_slave_agent_rp_valid;                                          // sysid_qsys_1_control_slave_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] sysid_qsys_1_control_slave_agent_rp_data;                                           // sysid_qsys_1_control_slave_agent:rp_data -> router_004:sink_data
	wire         sysid_qsys_1_control_slave_agent_rp_ready;                                          // router_004:sink_ready -> sysid_qsys_1_control_slave_agent:rp_ready
	wire         sysid_qsys_1_control_slave_agent_rp_startofpacket;                                  // sysid_qsys_1_control_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         sysid_qsys_1_control_slave_agent_rp_endofpacket;                                    // sysid_qsys_1_control_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [92:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire         sysid_qsys_1_control_slave_agent_rdata_fifo_src_valid;                              // sysid_qsys_1_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] sysid_qsys_1_control_slave_agent_rdata_fifo_src_data;                               // sysid_qsys_1_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         sysid_qsys_1_control_slave_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_002:in_0_ready -> sysid_qsys_1_control_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> sysid_qsys_1_control_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> sysid_qsys_1_control_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // sysid_qsys_1_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> sysid_qsys_1_control_slave_agent:rdata_fifo_sink_error
